...
public class controlman2 extends JFrame {
	...
	public controlman2()  {
		...
		btBack.setBounds(413, 679, 156, 64);
		
		btInquiry = new JButton("");
		btInquiry.setContentAreaFilled(false);
		btInquiry.setBounds(626, 190, 92, 27);
		...
		layeredPane.add(btInquiry, JLayeredPane.MODAL_LAYER);
